...
describe('TEST: FilesController', () => {
  ...
  describe('TEST: POST: /files', () => {
    it('TEST: Fails with no "X-Token" header field', function (done) {
      request.post('/files')
        .expect(401)
        .end((err, res) => {
          if (err) {
    ...
    it('TEST: Fails for a non-existent user', function (done) {
      this.timeout(5000);
      request.post('/files')
        .set('X-Token', 'raboof')
        .expect(401)
    ...
    it('TEST: Fails if name is missing', function (done) {
      this.timeout(5000);
      request.post('/files')
        .set('X-Token', token)
        .send({})
    ...
    it('TEST: Fails if type is missing', function (done) {
      this.timeout(5000);
      request.post('/files')
        .set('X-Token', token)
    ...
    it('TEST: Fails if type is available but unrecognized', function (done) {
      this.timeout(5000);
      request.post('/files')
        .set('X-Token', token)
    ...
    it('TEST: Fails if data is missing and type is not a folder', function (done) {
      this.timeout(5000);
      request.post('/files')
        .set('X-Token', token)
    ...
    it('TEST: Fails if unknown parentId is set', function (done) {
      this.timeout(5000);
      request.post('/files')
        .set('X-Token', token)
        .send({
    ...
    it('TEST: Succeeds for valid values of a file', function (done) {
      this.timeout(5000);
      request.post('/files')
        .set('X-Token', token)
        .send({
    ...
    it('TEST: Succeeds for valid values of a folder', function (done) {
      this.timeout(5000);
      request.post('/files')
        .set('X-Token', token)
        .send({
    ...
    it('TEST: Fails if parentId is set and is not of a folder or 0', function (done) {
      this.timeout(5000);
      request.post('/files')
        .set('X-Token', token)
        .send({
    ...
    it('TEST: Succeeds if parentId is set and is of a folder', function (done) {
      this.timeout(5000);
      request.post('/files')
        .set('X-Token', token)
        .send({
  ...
  describe('TEST: GET: /files/:id', () => {
    ...
    it('TEST: Fails if file is not linked to user', function (done) {
      this.timeout(5000);
      request.get('/files/444555666')
        .set('X-Token', token)
        .expect(404)
    ...
    it('TEST: Succeeds if file is linked to user', function (done) {
      this.timeout(5000);
  ...
  describe('TEST: GET: /files', () => {
    ...
    it('TEST: Fetches first page with no page query', function (done) {
      this.timeout(5000);
      request.get('/files')
        .set('X-Token', token)
        .expect(200)
    ...
    it('TEST: Fetches first page with no page query and parentId', function (done) {
      this.timeout(5000);
    ...
    it('TEST: Returns empty list for a page that is out of bounds', function (done) {
      this.timeout(5000);
    ...
    it('TEST: Returns empty list for a parentId of a file', function (done) {
      this.timeout(5000);
    ...
    it('TEST: Returns empty list for unknown parentId', function (done) {
      this.timeout(5000);
  ...
  describe('TEST: PUT: /files/:id/publish', () => {
    it('TEST: Fails with no "X-Token" header field', function (done) {
  ...
  describe('TEST: PUT: /files/:id/unpublish', () => {
    it('TEST: Fails with no "X-Token" header field', function (done) {
  ...
  describe('TEST: GET: /files/:id/data', () => {
    it('TEST: Fails if the file does not exist', function (done) {
    ...
    it('TEST: Fails if the file is not public and not requested by the owner', function (done) {
    ...
    it('TEST: Succeeds if the file is not public but requested by the owner', function (done) {
      request.get(`/files/${mockFiles[0].id}/data`)
        .set('X-Token', token)
        .expect(200)
        .end((err, res) => {
    ...
    it('TEST: Fails if the file is a folder', function (done) {
      this.timeout(5000);
    ...
    it('TEST: Succeeds if the file is not public but requested by the owner [alt]', function (done) {
    ...
    it('TEST: Fails if the file is not locally present', function (done) {
      this.timeout(5000);
      emptyFolder(baseDir);
      request.get(`/files/${mockFiles[2].id}/data`)
        .expect(404)
